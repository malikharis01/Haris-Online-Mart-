...
from product_consumer.proto import product_pb2, operation_pb2, inventory_pb2



from product_consumer.product_consumer.settings import BOOTSTRAP_SERVER, KAFKA_CONSUMER_GROUP_ID, KAFKA_PRODUCT_TOPIC, KAFKA_CONFIRMATION_TOPIC , KAFKA_INVENTORY_TOPIC
from product_consumer.models import Product
